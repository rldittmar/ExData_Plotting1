...
# Plot 4
## Prepare Global_active_power v. Datetime graph
with(mydates, plot(date.time,Global_active_power, type="l", xlab = "", ylab = "Global Active Power"))

## Prepare Submetering v. Datetime graph
...
## Prepare Voltage v. Datetime graph
with(mydates, plot(date.time,Voltage, type="l", xlab = "datetime", ylab = "Voltage"))

## Prepare Global Reactive Power v. Datetime graph
with(mydates, plot(date.time,Global_reactive_power, type="l", xlab = "datetime", ylab = "Global_reactive_power"))
